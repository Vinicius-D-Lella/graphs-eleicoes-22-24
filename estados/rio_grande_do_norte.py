...
with titulo:
    if ano_atual == 2022:
        st.title(f'RN 2022 - Candidatos à Deputado Federal')
    if ano_atual == 2024:
        st.title(f'RN 2024 - Candidatos à Vereador')


database = pd.read_csv(f'data/RN_{ano_atual}.csv', encoding="latin1", sep=",")
