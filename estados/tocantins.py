...
with titulo:
    if ano_atual == 2022:
        st.title(f'TO 2022 - Candidatos à Deputado Federal')
    if ano_atual == 2024:
        st.title(f'TO 2024 - Candidatos à Vereador')


database = pd.read_csv(f'data/TO_{ano_atual}.csv', encoding="latin1", sep=",")
